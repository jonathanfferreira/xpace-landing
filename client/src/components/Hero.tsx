        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-foreground">Dance Company</span>
            </motion.h1>
            ...
            >
              <Button
                size="lg"
                asChild
                className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 transition-opacity text-background font-bold shadow-lg shadow-primary/50"
              >
